...
use familiar_core::event::{AgentEvent, AgentEventType, AgentSource, AgentCategory, EventMetadata};
...
impl CliAgentHookAdapter {
    ...
    fn map_event_type(&self, event_name: &str, json: &Value) -> AgentEventType {
        match event_name {
            "SessionStart" | "start" => AgentEventType::AgentStarted,
            "Stop" | "stop" | "exit" => AgentEventType::AgentStopped,
            "PreToolUse" | "tool_call" => self.parse_pre_tool_use(json),
            "PostToolUse" | "tool_result" => AgentEventType::Processing { description: "Tool finished".into() },
            "PermissionRequest" => AgentEventType::WaitingForInput,
            "SubagentStart" => AgentEventType::SubagentStarted { agent_type: "Unknown".into() },
            "SubagentStop" => AgentEventType::SubagentStopped { agent_type: "Unknown".into() },
    ...
    fn parse_pre_tool_use(&self, json: &Value) -> AgentEventType {
        ...
        match tool_name {
            ...
            "Edit" | "Write" | "apply_patch" | "write_to_file" | "replace_file_content" | "multi_replace_file_content" => {
            ...
            "view_file" | "read_file" | "cat" => {
                let path = args["AbsolutePath"].as_str()
